...
print "<li><a href= ../vista/maestros_es.php >Regresar</a>";
print "<li><a href= ../controlador/reporte_brigadas.php>Reporte</a></li><br><br>";
...
/************Datos Basicos***************************************************/		
		...
		function brig ($h){
		global $b;
		$consulta = "SELECT * FROM brigada WHERE hora_clase = '$h' AND no_empleado= '$b'"; 
...
<table border="1" align="center">
    ...
    <tr>
      ...
      <td>M1-M2</td>
	  <?php for ($i=1; $i<=6;$i++){
      print "<td>";if (brig($i)){print "<p><a class ='detalle' href ='det_brigada_mes.php?brig=$i'>Detalles</a></p>"; print "</td>";}
      }
	  ?>
